...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{static/report_dementia_baseline.png}
        \caption{Dementia Baseline (Fragmented)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{static/report_dementia_repaired.png}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{static/report_ptsd_baseline.png}
        \caption{PTSD Baseline (Hyper-Hubs)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{static/report_ptsd_repaired.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Neurons Added: 341
        \item Pathology Reduction: -706.2\%
        \item Homology Restoration: $\beta_0$ decreased by 0, indicating re-connection of fragmented components.
    \end{itemize}
    
    \item \textbf{PTSD Repair}:
    \begin{itemize}
        \item Neurons Added: 35
        \item Pathology Reduction: -1775.0\%
        \item Loop Resolution: $\beta_1$ decreased by 569, signalling the breaking of traumatic reverb loops.
    \end{itemize}
\end{itemize}
