#!/usr/bin/env python3
"""
Nature Technical Publication: Enhanced Quantum MR Thermometry
...
def generate_nature_finite_math_report(
    B0: float = 3.0,
    n_echoes: int = 10,
    matrix: int = 128,
    ...
    # ── 5. Build PDF ─────────────────────────────────────────────────────────
    pdf_name = f"Nature_FiniteMath_MR_Thermometry_{B0:.0f}T_{timestamp}.pdf"
    ...
    elements.append(Paragraph(
        "Enhanced Quantum MR Thermometry:<br/>"
...
if __name__ == "__main__":
    out = generate_nature_finite_math_report(
        B0=3.0,
        n_echoes=10,
        matrix=128,
        hotspot_dT=6.0,
