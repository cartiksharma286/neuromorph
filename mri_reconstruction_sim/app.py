...
def get_snr_matrix():
    ...
    try:
        ...
        sequences = ['SE', 'GRE', 'STIR', 'FLAIR', 'Spiral', 'EPI', 'T2*', 'DementiaCurePulse', 'Prostate_DCI_Phi']
...
def generate_seq():
    ...
    try:
        ...
        SEQ_PARAMS = {
            'Prostate_DCI_Phi':          {'desc': 'Prostate DCI (Continued Fraction Phi Spin Echo)', 'rf_shape': 'sinc'},
...
from quantum_neuroimaging_qml import get_stroke_repair_sequence, get_dementia_cure_sequence, get_sr_qml_60_sequence
