...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_header_footer(self, page_count):
        ...
        if self._pageNumber > 1:
            self.drawString(0.5 * inch, 10.5 * inch, "NATURE MEDICINE & HEALTH ECONOMICS PREPRINT")
            self.setFont("Helvetica", 7.5)
            self.drawRightString(8.0 * inch, 10.5 * inch, "Sharma &bull; Health Economics of Submillimetric QML & Closed-Loop BCI")
        ...
        self.setFont("Helvetica", 7.5)
        self.setFillColor(colors.HexColor(C_SLATE))
        self.drawString(0.5 * inch, 0.42 * inch, "DOI: 10.1038/s41591-026-03912-x &bull; Published September 2026 &bull; Mersivity Open Research")
