...
class MRICoilApp {
    ...
    updateGeodesicView() {
        ...
        const coilRadius = parseInt(document.getElementById('coilRadius')?.value || 120);

        // Update scale based on radius (120mm = 200 scale reference)
        geodesicEngine.scale = (coilRadius / 120) * 200;
